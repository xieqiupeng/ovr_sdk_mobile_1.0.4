...
namespace Capture
{
	...
	class StreamProcessor
	{
		...
		private:
			...
			virtual void onMemoryAlloc(  Capture::UInt32 threadID, double timeInSeconds, Capture::UInt32 size, Capture::UInt64 ptr) {}
			virtual void onMemoryRealloc(Capture::UInt32 threadID, double timeInSeconds, Capture::UInt32 size, Capture::UInt64 oldPtr, Capture::UInt64 newPtr) {}
			virtual void onMemoryFree(   Capture::UInt32 threadID, double timeInSeconds, Capture::UInt64 ptr) {}
			virtual void onHeadTransform(double timeInSeconds, const Capture::Quaternion &orientation, const Capture::Vector3 &position) {}
			virtual void onCPUContextSwitch(double timeInSecondsBegin, double timeInSecondsEnd, Capture::UInt32 threadID, Capture::UInt32 cpuID) {}
			virtual void onNewButton(    Capture::UInt32 labelID) {}
