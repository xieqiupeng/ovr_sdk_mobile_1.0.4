...
ovrParseResult ParseObject( ovrReflection & refl, ovrLocale const & locale, const char * name, ovrLexer & lex, ovrTypeInfo const * objectTypeInfo, void * objPtr, const size_t /*arraySize*/ )
{
	const int MAX_TOKEN = 1024;
	char token[MAX_TOKEN];
