...
ovrEnumInfo VRMenuEventType_Enums[] =
{
	...
	{ "VRMENU_EVENT_ITEM_ACTION_COMPLETE",	20 },
	{ "VRMENU_EVENT_MAX",					21 }
};
...
void ResizeArray( void * objPtr, const int newSize )
{
...
{ 
	ResizeArray< OVR::Array< VRMenuComponent* > >( objPtr, newSize );
}
...
{
	ResizeArray< OVR::Array< VRMenuSurfaceParms > >( objPtr, newSize );
}

void Resize_OVR_Array_VRMenuObjectParms_Ptr( void * objPtr, const int newSize ) 
{ 
	ResizeArray< OVR::Array< VRMenuObjectParms* > >( objPtr, newSize );
}
